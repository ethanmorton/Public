...
!===========================================================================================================================
        contains
            ...
            subroutine initialize(pot,h,grid,imax,width,sep,nmax,u)
            ...
            subroutine calculate(pot,h,imax,width,sep,error)

                IMPLICIT NONE
                real*8 h,error,pot_old
...
!------------------------------------------------------------------------------------------------------------
        ...
        call initialize(pot,h,grid,imax,width,sep,nmax,u)

        do niter=1,nmax
            call calculate(pot,h,imax,width,sep,error)
            if(error < 1E-05) exit
        enddo
